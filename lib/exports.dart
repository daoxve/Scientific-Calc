...
export 'package:scientific_calc/app/app.logger.dart';
export 'package:scientific_calc/app/app.router.dart';

// Styles
export 'package:scientific_calc/styles/textstyles.dart';
export 'package:scientific_calc/styles/strings.dart';
export 'package:scientific_calc/styles/colors.dart';

// Views
export 'package:scientific_calc/ui/help/help_view.dart';
export 'package:scientific_calc/ui/history/history_view.dart';
...
export 'package:scientific_calc/ui/dumb_widgets/plain_button.dart';
export 'package:scientific_calc/ui/widgets/home_tophalf.dart';
export 'package:scientific_calc/ui/widgets/home_bottomhalf.dart';
